...
class ProductController(
    ...
    fun searchByCategory(@PathVariable categoryName: String): ResponseEntity<List<ProductResponseDto>> {
        return ResponseEntity.ok(productService.searchByCategory(categoryName))
    }
